...
function Component(){
    ...
    const [graphType, setGraphType] = useState("circular");
    ...
    useEffect(() => {
        ...
        audio.addEventListener("ended", progressEnd);
            ...
            <div className={style.container} style={{width: '100%', height: '100%'}}>
                <div className={style.control}>
                    <AudioControl onSwitchPlay={onSwitchPlay} paused={paused} onAudioFile={onAudioFile} 
                        progress={progress} volume={volumn} onVolumnChange={changeVolumn}
                        onLoopChange={setLoop} onVisualChange={setEffect} loop={loop} visual={effect} onTimeChange={changeTime}
